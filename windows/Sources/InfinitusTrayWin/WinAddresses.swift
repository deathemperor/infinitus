...
// Duplicated from windows/Sources/InfinitusWin/WinAddresses.swift because
...
/// IPv4 interface addresses for pairing URL generation.
enum WinAddresses {
    /// Every IPv4 address on an up, non-loopback adapter, in adapter order, de-duplicated.
    ...
    /// The dotted quad of a `sockaddr_in`.
