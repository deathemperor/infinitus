...
func usage() -> String {
    ...
    out += "proxy-key, 9router-password, aws-login-code and gcloud-login-code read their secret from stdin.\n"
...
var secret: String?
if ["proxy-key", "9router-password", "aws-login-code", "gcloud-login-code", "aws-login-callback", "event", "send", "approve"].contains(command) {
