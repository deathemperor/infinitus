...
public struct ControlCommand: Codable, Sendable, Equatable {
    ...
    public static let all: [ControlCommand] = [
        ...
        ControlCommand(name: "show", args: ["settings"], effect: .write,
                       summary: "Open the Settings window. The pop-out, wall, workspace and session windows are retired — the Infinitus desktop app is the client.",
                       replyShape: "{shown}"),
        ...
        ControlCommand(name: "hide", args: ["settings"], effect: .write,
                       summary: "Close the Settings window.",
                       replyShape: "{hidden}"),
