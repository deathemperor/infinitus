...
import { DesktopSshPasswordPromptResolutionInputSchema } from "@infinitus/contracts";
import type { SshPasswordRequest } from "@infinitus/ssh/auth";
...
>()("@infinitus/desktop/ssh/DesktopSshPasswordPrompts") {}
