import { EnvironmentId, type PersistedSavedEnvironmentRecord } from "@infinitus/contracts";
import { fromLenientJson } from "@infinitus/shared/schemaJson";
...
>()("@infinitus/desktop/settings/DesktopSavedEnvironments") {}
