...
import { EnvironmentId, ProviderInstanceId, ThreadId } from "@infinitus/contracts";
...
vi.mock("@infinitus/client-runtime/state/runtime", async (load) => ({
  ...(await load<typeof import("@infinitus/client-runtime/state/runtime")>()),
