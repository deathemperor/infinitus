import { EnvironmentId, type DeviceDetail, type DeviceSummary } from "@infinitus/contracts";
import type { DeviceHubAccess } from "@infinitus/client-runtime/device/hub-access";
