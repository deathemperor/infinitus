...
import type { DuoViewer } from "@infinitus/client-runtime/device/duo-viewer";
import type { DeviceModelSource } from "@infinitus/client-runtime/device/model";
import { createPhoneInteraction } from "@infinitus/client-runtime/device/phone-interaction";
import { createCanvasFrameSink } from "@infinitus/client-runtime/device/frame";
import type { DeviceScreenSize, DeviceStreamClient } from "@infinitus/client-runtime/device/stream";
import { createDuoPinch } from "@infinitus/client-runtime/device/duo-control";
import { bindPhoneTrackpad } from "./phoneTrackpad";

const loadDuoViewer = () => import("@infinitus/client-runtime/device/duo-viewer");
