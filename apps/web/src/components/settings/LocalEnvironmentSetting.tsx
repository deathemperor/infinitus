  ...
  return (
    <>
      <SettingsRow
        ...
        description={
          enabled
            ? `Run agents on this computer. Turn off to use ${PRODUCT_NAME} only with remote environments.`
      ...
      >
        <AlertDialogPopup>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              {enabled
                ? `${PRODUCT_NAME} will restart without running a server on this computer. Any agents and terminals running here will stop, and other devices will no longer be able to connect to this computer. Your projects, history, and remote environments are unaffected.`
                : `${PRODUCT_NAME} will restart and start running a server on this computer again.`}
            </AlertDialogDescription>
          </AlertDialogHeader>
