...
export function ProjectDefaultsSettings({ category }: { category: ProjectSettingsCategory }) {
  ...
  // the checkout's project file, and a null file here only fills the built-in.
    ...
    <SettingsRow
      ...
      description={
        isProjectScope
          ...
          : "Where new threads start. Projects and their infinitus.json can override it."
      }
      resetAction={
          ...
          <SettingsRow
            ...
            description={
              isProjectScope
                ...
                : "How new worktrees populate git submodules. Projects and their infinitus.json can override it."
            }
            resetAction={
