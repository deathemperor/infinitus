...
export const SETTINGS_SEARCH_ITEMS = [
  ...
  },
  {
    ...
    // link; the page is this Mac's name, the server's port, iCloud sync, and
    // the pairing requests a phone sends.
    searchTerms: ["phone pair port name icloud", "machine sync"],
  },
  {
