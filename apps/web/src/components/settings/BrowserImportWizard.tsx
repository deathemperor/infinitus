      ...
      <DialogPanel>
        ...
        {!permission.isReady(["fullDiskAccess"]) ? (
          <p className="mt-3 text-xs text-muted-foreground">
            {stillRequired
              ? `Access is still required. Quit and reopen ${PRODUCT_NAME} if you just allowed it, then retry the import.`
              : `If access doesn't update after you allow it, quit and reopen ${PRODUCT_NAME}, then retry the import.`}
          </p>
        ) : null}
      </DialogPanel>
      <DialogFooter>
