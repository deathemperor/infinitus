...
export interface ProjectScriptEditorRequest {
  ...
  /** Validation error to show immediately (e.g. a failed project file import). */
  error?: string;
}
              ...
              <fieldset className="space-y-4" disabled={isSaving}>
                ...
                <div className="space-y-1.5">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    and <code>$T3CODE_PORT</code>–<code>$T3CODE_PORT_END</code>: ten ports picked
                    per worktree, so each checkout's dev server gets its own.
                  </p>
                </div>
                <div className="space-y-1.5">
