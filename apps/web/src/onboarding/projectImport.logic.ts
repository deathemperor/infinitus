import { findProjectByPath } from "@infinitus/client-runtime/state/projects";
import type { AgentSessionProjectCandidate, EnvironmentId, ProjectId } from "@infinitus/contracts";
