      ...
      {presented === null ? null : (
        <View className="flex-1 items-center justify-center bg-backdrop px-8">
          <View className="w-full rounded-[24px] bg-card px-6 pb-4 pt-5">
            <AppText className="text-lg font-infinitus-medium">{presented.request.title}</AppText>
            ...
            <View className="mt-5 flex-row justify-end gap-1">
              <View className="overflow-hidden rounded-full">
                ...
                >
                  <AppText className="text-base font-infinitus-medium">
              ...
              <View className="overflow-hidden rounded-full">
                ...
                >
                  <AppText
                    className={cn(
                      "text-base font-infinitus-medium",
