...
import { type EnvironmentMachineKind, resolveEnvironmentMachineKind } from "@infinitus/contracts";
...
function CacheEnvironmentRow(props: {
  ...
  return (
    ...
    >
      ...
      >
        <Text
          className="font-infinitus-medium tabular-nums text-danger-foreground"
          numberOfLines={1}
        >
