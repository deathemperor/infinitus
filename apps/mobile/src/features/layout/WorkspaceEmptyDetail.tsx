...
<<<<<<< HEAD
      <View className="max-w-[360px] items-center gap-3">
        <SymbolView
          ...
          type="hierarchical"
        />
        <Text className="text-center text-xl font-infinitus-bold">Select a thread</Text>
        ...
        {props.onStartNewTask ? (
          ...
          >
            <Text className="text-base font-infinitus-bold text-primary-foreground">New Task</Text>
          </Pressable>
        ) : null}
      </View>
=======
          ...
          {props.onStartNewTask ? (
            Platform.OS === "android" ? (
              ...
              <Pressable
                ...
                onPress={props.onStartNewTask}
              >
                <Text className="text-base font-infinitus-bold text-primary-foreground">
                  New Task
                </Text>
              </Pressable>
            )
