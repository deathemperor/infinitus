...
import { DEFAULT_TERMINAL_ID, type ProjectScript } from "@infinitus/contracts";
import { nextTerminalId, resolveTerminalSessionLabel } from "@infinitus/shared/terminalLabels";
