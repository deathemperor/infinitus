      ...
      >
        <View className="gap-3 rounded-[22px] border border-border bg-card px-4 py-4">
          <View className="flex-row items-center justify-between gap-3">
            ...
            <Text className="text-foreground text-base font-infinitus-bold">
        ...
        <View className="gap-3 rounded-[22px] border border-border bg-card px-4 py-4">
          <View className="flex-row items-center justify-between gap-3">
            <View className="gap-1">
              <Text className="text-foreground text-base font-infinitus-bold">Files</Text>
            ...
            >
              ...
              <Text
                className={cn(
                  ...
                  Platform.OS === "android" ? "font-infinitus-medium" : "font-infinitus-bold",
                )}
              >
                {gitStatus.data?.refName ?? "(detached HEAD)"}
          ...
          >
            <View className="flex-row items-center justify-between gap-3">
              <View className="gap-1">
                ...
                >
<<<<<<< HEAD
                  <Text className="text-foreground text-2xs font-infinitus-bold uppercase">
                    Reset
                  </Text>
                </Pressable>
              ) : null}
...
<<<<<<< HEAD
                    ...
                    <View className="flex-row items-start justify-between gap-3">
                      <View className="flex-1 gap-1">
                        <Text
                          selectable
                          className={`text-sm font-infinitus-bold ${included ? "text-foreground" : "text-foreground-muted"}`}
                        >
                          {file.path}
                        </Text>
                        {!included ? (
...
<<<<<<< HEAD
        <View className="gap-2">
          <Text className="text-foreground text-sm font-infinitus-bold">Commit message</Text>
          <TextInput
            multiline
...
>>>>>>> upstream-sync-d4d5d12e8-upstream-renamed
          ...
          >
            <Text
              className={
                Platform.OS === "android"
                  ? "text-foreground text-base font-infinitus-medium"
                  : "text-foreground text-sm font-infinitus-bold"
              }
            >
              Commit message
            </Text>
