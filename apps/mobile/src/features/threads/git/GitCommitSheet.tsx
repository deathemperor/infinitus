      ...
      <MaterialScreenContent fitToContents>
        ...
        >
            ...
            <View className="flex-row items-center justify-between gap-3">
              ...
              <View className="flex-row items-center gap-2">
                {!allSelected && isEditingFiles ? (
                  ...
                  >
                    <Text className="android:text-primary-text android:text-sm android:font-infinitus-medium ios:text-foreground ios:text-2xs ios:font-infinitus-bold ios:uppercase">
                      Reset
                    </Text>
                  </Pressable>
                ) : null}
          ...
          <View className="android:gap-3 android:rounded-[20px] android:bg-card android:p-4 ios:gap-2">
            <Text className="text-foreground android:text-base android:font-infinitus-medium ios:text-sm ios:font-infinitus-bold">
              Commit message
            </Text>
            <TextInput
              multiline
