...
export function SheetActionButton(props: {
  ...
  return (
    ...
    >
      ...
      <Text
        className={cn(
          "text-xs font-infinitus-bold tracking-[0.9px] uppercase",
          tone === "primary"
...
<<<<<<< HEAD
        <Text className="text-foreground text-base font-infinitus-bold">{props.title}</Text>
=======
        <Text
          className={
            Platform.OS === "android"
              ? "text-foreground text-base font-infinitus-medium"
              : "text-foreground text-base font-infinitus-bold"
          }
        >
          {props.title}
        </Text>
