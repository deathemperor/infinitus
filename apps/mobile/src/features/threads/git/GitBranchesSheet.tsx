...
<<<<<<< HEAD
      ...
      >
        <View className="gap-2 rounded-[18px] border border-border bg-card px-4 py-4">
          <Text className="text-foreground-secondary text-2xs font-infinitus-bold tracking-[1px] uppercase">
            New branch
          </Text>
          <TextInput
            value={newBranchName}
            ...
            <Text
              className={
                Platform.OS === "android"
                  ...
                  : "text-foreground-secondary text-2xs font-infinitus-bold tracking-[1px] uppercase"
              }
            >
              New branch
>>>>>>> upstream-sync-d4d5d12e8-upstream-renamed
          ...
          <View className="gap-2">
            <Text
              className={
                Platform.OS === "android"
                  ? "px-4 pb-1 pt-3 text-foreground-secondary text-sm font-infinitus-medium"
                  : "text-foreground-secondary text-2xs font-infinitus-bold tracking-[1px] uppercase"
              }
            >
              Existing branches
...
<<<<<<< HEAD
                ...
                <Text className="text-foreground text-base font-infinitus-bold">{branch.name}</Text>
