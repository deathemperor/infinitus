...
import { EnvironmentProject, EnvironmentThreadShell } from "@infinitus/client-runtime/state/shell";
import type { AtomCommandResult } from "@infinitus/client-runtime/state/runtime";
import {
  type GitActionRequestInput,
  type VcsActionOperation,
  type VcsRef,
} from "@infinitus/client-runtime/state/vcs";
import type { GitRunStackedActionResult } from "@infinitus/contracts";
import {
