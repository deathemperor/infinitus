...
const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    ...
    usageBaseline: Schema.NullOr(Schema.fromJsonString(ThreadUsageRollup)),
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.usage == null ? null : JSON.stringify(row.usage)},
          ${row.usageBaseline == null ? null : JSON.stringify(row.usageBaseline)},
          ${row.sideOf ?? null},
          ${row.groupId ?? null},
          ${row.pinnedAt},
        ...
        DO UPDATE SET
          ...
          usage_baseline_json = excluded.usage_baseline_json,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          usage_json AS "usage",
          usage_baseline_json AS "usageBaseline",
          side_of AS "sideOf",
          group_id AS "groupId",
