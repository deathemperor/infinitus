...
final class TeamSnapshotTests: XCTestCase {
    ...
    func testMakeOrdersLeadersFirstAndFoldsReaderRows() throws {
        ...
        let docs: [String: Data] = [
            ...
            "m/\(a.kid)/now.json": try CanonicalJSON.encode(TeamDocs.Now(at: 100, machine: "bo", live: [TeamDocs.LiveThread(id: "s", title: "App", project: "app")],
                                                                        fleets: [], blockers: ["AWS login: prod"], crashesToday: 1, sharesTo: [:], desktop: true)),
        ...
        XCTAssertEqual(bo.threadsNow, 1)
