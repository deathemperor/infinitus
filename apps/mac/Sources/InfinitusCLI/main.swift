...
var secret: String?
if stdinPiped, ["proxy-key", "9router-password", "push-slack", "push-telegram", "aws-login-code", "gcloud-login-code", "signin-code", "aws-login-callback", "event", "push", "send", "approve", "permission", "desktop-credential"].contains(command) {
