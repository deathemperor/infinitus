...
var secret: String?
if stdinPiped, ["proxy-key", "9router-password", "push-slack", "push-telegram", "aws-login-code", "gcloud-login-code", "signin-code", "aws-login-callback", "push", "send", "permission", "team-create", "team-join", "team-hostname", "desktop-credential"].contains(command) {
