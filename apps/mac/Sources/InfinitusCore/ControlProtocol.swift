...
public struct ControlCommand: Codable, Sendable, Equatable {
    ...
    public static let all: [ControlCommand] = [
        ...
        ControlCommand(name: "9router", effect: .read,
                       summary: "9Router settings: base URL, whether a password is stored, whether the engine is on, and the last error its refresh failed with.",
                       replyShape: "{baseURL, passwordPresent, enabled, error?}"),
