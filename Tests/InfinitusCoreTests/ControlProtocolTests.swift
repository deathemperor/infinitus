...
final class ControlProtocolTests: XCTestCase {
    ...
    func testTheManifestDeclaresWhichVerbsTakeASecret() {
        ...
        XCTAssertEqual(secret, ["aws-login-callback", "aws-login-code", "gcloud-login-code", "signin-code", "team-create", "team-join", "team-hostname", "proxy-key", "9router-password", "push-slack", "push-telegram"])
