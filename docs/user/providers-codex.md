...
Both instances must use the same **CODEX_HOME path**. Infinitus prepares the shared
...
Choose the other account from the thread's model picker. Infinitus offers compatible
