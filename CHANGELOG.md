...
### Mac
- Add account and Re-login sign the sheet out of claude.ai first, then sign in with your remembered Google accounts and passkeys — no email to type, no account switch.
