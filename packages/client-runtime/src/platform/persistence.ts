...
>()("@infinitus/client-runtime/platform/persistence/ConnectionTargetStore") {}
...
>()("@infinitus/client-runtime/platform/persistence/ConnectionRegistrationStore") {}
...
>()("@infinitus/client-runtime/platform/persistence/EnvironmentCacheStore") {}
...
}>("@infinitus/client-runtime/platform/persistence/EnvironmentOwnedDataCleanup", {
  defaultValue: () => ({
    clear: () => Effect.void,
  }),
}) {}
