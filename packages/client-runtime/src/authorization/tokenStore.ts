...
import { RelayManagedEndpoint } from "@infinitus/contracts/relay";
...
export class RemoteDpopAccessToken extends Schema.Class<RemoteDpopAccessToken>(
  "@infinitus/client-runtime/authorization/RemoteDpopAccessToken",
)({
...
>()("@infinitus/client-runtime/authorization/tokenStore/RemoteDpopAccessTokenStore") {}
