import type { ThreadEnvMode } from "@infinitus/contracts";

/**
 * Canonical priority order for a project's default thread env mode:
 * per-project setting > checked-in project file > global server setting.
 *
 ...
 * source that outranks the project file decided, or the file read settled. While
